...
class New_Party_ViewController: UIViewController, CLLocationManagerDelegate , UITableViewDelegate ,UITableViewDataSource, UISearchBarDelegate{

    @IBOutlet weak var party_name_textbox: UITextField!
    @IBOutlet weak var location_search_bar: UISearchBar!
